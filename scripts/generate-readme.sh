...
collect_files() {
  ...
  for f in "$DOCS_DIR/overview.md" "$DOCS_DIR/architecture.md" "$DOCS_DIR/ARCHITECTURE_RULES.md" "$DOCS_DIR/development-guide.md" "$DOCS_DIR/critical-recommendations.md" "$DOCS_DIR/documentation-map.md"; do
    [ -f "$f" ] && files+=("$f")
  done
